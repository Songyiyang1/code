...
/*
Dear reader: the manunal string construction in here is error-prone and annoying. For later exercise sheets,
we switched to a proper string builder hepler struct. If you want to modify these tests,
please use that struct (see, for example, B10_Semesteraufgaben/10ex.test for how to use it).
*/
